...
var JEELIZFACEFILTER = (function () {
  window.JEELIZFACEFILTERGEN = function () {
    function Fb(a) {
      ...
      this.Cf = function (n) {
        ...
        c = n.map(function (r, l) {
          r = Object.assign({}, r, { index: l, parent: this, vb: q, ff: l === m - 1 });
    ...
    function Ib(a) {
      ...
      for (var r = 0; r < e; ++r) {
        for (
          var l = q * r, v = 0 === db(c, l) ? 1 : -1, C = l + 1, E = 1, g = 0, t = C + a - 1;
          t >= C;
          --t
        )
          (g += E * db(c, t)), (E *= 2);
    ...
    function Kb() {
      ...
      if (!B.kb)
        if (B.jb)
          B.element.needsUpdate && (B.N.Rf(B.element.arrayBuffer), (B.element.needsUpdate = !1));
        else {
      ...
      for (var a = 0; a < O.o; ++a)
        if (-1 !== O.W.indexOf(a)) {
          ...
          if (d.Wa < ea.multiDetectionThresholdFactors[0] * ea.threshold)
            ...
            m.rx = wa.$(m.rx, d.sc, n);
            m.ry = wa.$(m.ry, d.tc, n);
            m.rz = Q.ua ? m.rz + sa.followZRotAlphaFactor * n * d.Qa : wa.$(m.rz, d.Qa, n);
    ...
    function sb() {
      ...
      X.Da = Ob.instance({ width: a, height: c, isFloat: !0, isPot: !1, array: e });
    }
    function Pb() {
      function a(c) {
      ...
      Sa = a({ Wa: 0, x: 0, y: 0, ca: 1, sc: 0, tc: 0, Qa: 0, hd: new Float32Array(X.aa), Aa: 0 });
      qa = a({
        detected: 0,
        x: 0,
        y: 0,
    ...
    function jb() {
      ...
      A.T('s56', [
        ...
        { type: '3f', name: 'u46', value: [X.O[0] * Z.H[0], X.O[1] * Z.H[1], X.O[2]] },
        { type: '1f', name: 'u41', value: 0.5 },
    ...
    function Tb() {
      ...
      X.Da.Bf(1);
      1 !== O.o &&
        (b.viewport(0, 0, 3, O.o), A.set('s0'), A.Xd('u1', 1), U.l(!1, !1), A.Xd('u1', 0));
      b.viewport(0, a, 1, 1);
      A.set('s56');
    ...
    function xb() {
      ...
      B.zc = Y.instance(Object.assign({ isPot: !1, isLinear: !0, isFloat: !1 }, a));
      B.N = B.zc;
    }
    function Ia() {
    ...
    function yb() {
      ...
      if (!a.w || !a.wa || 4 > a.w || 4 > a.wa)
        throw Error('INVALID VIDEO DIMENSIONS - width = ' + a.w + ' height = ' + a.wa);
      return a;
    }
    function lb() {
      var a = yb(),
    ...
    function zb(a, c, d) {
      ...
      B.La = {
        video: {
          ...
          height: { min: oa.minHeight, max: oa.maxHeight, ideal: oa.idealHeight },
        },
        audio: !1,
      };
    ...
    var wa = {
      ...
      Vb = {
        Me: function (a, c, d) {
          switch (a) {
            ...
            case 'elu':
              return (
                d + '=mix(exp(-abs(' + c + '))-vec4(1.,1.,1.,1.),' + c + ',step(0.,' + c + '));'
              );
            case 'elu01':
              return (
                d +
        ...
        var q = [],
          ...
          M = {
            ...
            wc: function (u) {
              return m(
                u,
                { h: 'void main(){gl_FragColor=vec4(.5,.5,.5,.5);}', i: [], precision: 'highp' },
                's42'
              );
            },
            Je: function (u) {
      ...
      Qa = (function () {
        ...
        var e = null,
          ...
          E = {
            ...
            Jg: function () {
              va.P();
              m || ((m = document.createElement('canvas')), (n = m.getContext('2d')));
              m.width = e.width;
              m.height = e.height;
              for (
                var g = E.Pe(),
            ...
            A: function (g) {
              ...
              if (b) r = b instanceof WebGL2RenderingContext;
                ...
                b
                  ? (r = !0)
                  : ((b = e.getContext('webgl', t)) || (b = e.getContext('experimental-webgl', t)),
                    (r = !1));
              }
            ...
            af: function () {
              if (!C) {
                for (var h = new Float32Array(16384), F = 0; 16384 > F; ++F)
                  h[F] = 2 * Math.random() - 1;
                C = {
                  random: L.instance({ isFloat: !0, isPot: !0, array: h, width: 64 }),
                  de: L.instance({
                    isFloat: !1,
                    isPot: !0,
                    width: 1,
            ...
            instance: function (h) {
                  ...
                  if (aa.la()) {
                    ...
                    fa === b.RGBA && ha === b.FLOAT
                      ? w.isMipmap || w.isLinear
                        ...
                        ? D && (ja = D)
                        : (ja = b.RGBA16F || b.RGBA)
                      : fa === b.RGB && ha === b.FLOAT && D && ((ja = D), (fa = b.RGBA));
                  }
                  if ((w.S && !w.isFloat) || (w.isFloat && w.isMipmap && Ca.hf()))
                    (ja = aa.Se()), (ha = aa.Vb(b));
                  w.ic && (ab = w.ic);
              ...
              var ca = {
                ...
                Zc: function (D) {
                  ...
                  A.set('s13');
                  ca.g(0);
                  if (D) b.viewport(0, 0, R, T), A.xc('u9', 0.25, 0.25, 0.25, 0.25), ma.l(!1, !0);
                  else
                    for (D = 0; 4 > D; ++D)
                      b.viewport(0, T * D, R, T), A.xc('u9', J[D]), ma.l(!1, 0 === D);
                },
                Rf: function (D) {
                  var S = ha === g[0] && !m();
                  a(ta);
                ...
                th: function (D, S) {
                  ...
                  if ('RGBA' === D || 'RGBE' === D || 'RGBAARRAY' === D) {
                    ...
                    I ||
                      ((N = document.createElement('canvas')), (z = N.getContext('2d')), (I = !0));
                    N.width = R;
                    N.height = T;
                    ...
                    if (S)
                      ...
                      for (V = 0; 4 > V; ++V)
                        b.viewport(0, T * V, R, T), A.xc('u9', J[V]), ma.l(!V, !V);
                      ca.Rd();
                      V = Array(ka);
                      for (S = 0; S < ka; ++S)
                        (V[4 * S] = ya[0][S]),
                ...
                w.array
                  ? (w.S && !w.isFloat
                      ...
                      : ((ua = w.isFloat
                        ...
                        P()),
                    w.isKeepArray || (ua && ua !== w.array && (ua = null), delete w.array))
                  : w.Zb
                  ? (Ta = !0)
                  : P();
              ca.Ug = ca.F;
          ...
          q = {
            ...
            A: function () {
              if (!e) {
                ...
                var r = aa.la();
                c = r && b.DRAW_FRAMEBUFFER ? b.DRAW_FRAMEBUFFER : b.FRAMEBUFFER;
              ...
              var p = {
                ...
                remove: function () {
                  E === a ||
                    ...
                    g && b.framebufferRenderbuffer(c, b.DEPTH_ATTACHMENT, b.RENDERBUFFER, null),
                    b.bindFramebuffer(c, null),
          ...
          x = {
            A: function () {
              ...
              if (!q.xd) {
                ...
                q.Bd = q.Ac ? !0 : !1;
                if (q.Bd || x.la())
                  (q.Bc = x.fd(k)), (q.gf = q.Bc ? !0 : !1), (t.GL_EXT_FLOATLINEAR = q.Bc);
                q.xd = !0;
              }
              if (!q.yd) {
                q.Cc = x.Za(k);
            ...
            Vb: function (k) {
              var p = x.Za(k);
              return p && p.HALF_FLOAT_OES ? p.HALF_FLOAT_OES : k.HALF_FLOAT || k.FLOAT;
            },
            Re: function () {
            ...
            Ab: function (k, p, H) {
              ...
              if (
                k.checkFramebufferStatus(k.READ_FRAMEBUFFER || k.FRAMEBUFFER) !==
              ...
              I();
              for (H = 0; 36 > H; ++H) if (3 !== H % 4 && 3 < Math.abs(p[H] - 127)) return !1;
              return !0;
            },
            Lb: function (k) {
              var p = { ja: !1, ka: !1 };
            ...
            xb: function (k, p, H, I, N) {
              if (!x.ue())
                return b.readPixels(k, p, H, I, b.RGBA, b.UNSIGNED_BYTE, N), Promise.resolve(N);
              null === g.va &&
                ((g.X = b.PIXEL_PACK_BUFFER), (g.va = b.createBuffer()), (g.Yb = -1));
              b.bindBuffer(g.X, g.va);
              N.byteLength !== g.Yb &&
                (b.bufferData(g.X, N.byteLength, b.STREAM_READ), (g.Yb = N.byteLength));
        ...
        return {
          instance: function (a) {
            ...
            switch (l) {
              ...
              case 'inputMix0':
                r = 'none';
                m = Zb.instance({ D: v, ee: a.varianceMin, Sc: a.blurKernelSizePx, mb: !1 });
                e = !0;
                break;
              case 'direct':
              case 'none':
      ...
      Hb = (function () {
        return {
          instance: function (a) {
            ...
            var d = { input: null, Ua: null, bc: null, ba: null, tb: null, oc: null, pc: null },
              e = null,
              m = [],
              n = [],
              q = !1,
              ...
              x = { isEnabled: !1 };
            a.ff
              ? ((a.sparsity = 'undefined' !== typeof a.sparsity ? a.sparsity : a.vb.Wb()),
                (l = !1))
            ...
            var L = {
                ...
                switch (a.connectivityUp) {
                  ...
                  case 'conv':
                    (v = a.kernelsCount),
                      ...
                      C && (d.tb = Y.instance({ width: I, isFloat: !0, isFlipY: !1, isPot: !1 }));
                }
                if (G.Ca) {
                  var h = a.size * a.sparsity;
                  y = Math.log(h / a.size) / Math.log(2);
                  d.input = Y.instance({ isMipmap: !0, isFloat: !0, isPot: !0, width: h, ic: y });
              ...
              Be: function (h) {
                ...
                d.ba = Y.instance({ isFloat: !0, isPot: !0, isMipmap: !1, width: a.size });
                h =
                ...
                for (var F = 0, K = 0, P = 0; F < h; ++F)
                  m.push(K + (a.size - 1 - P) * a.size),
                    ...
                    ++K,
                    K === a.size && ((K = 0), ++P);
                a.normalize && (d.pc = Y.instance({ isFloat: !0, isPot: !0, width: a.size }));
              },
              vf: function (h) {
                return h.xf().then(c);
              },
      ...
      ac = (function () {
        return {
          instance: function (a) {
            ...
            var za = Y.instance({ width: m, isFloat: !0, array: new Float32Array(E), isPot: !0 });
            E = null;
            var w = Y.instance({ width: m, isFloat: !0, array: new Float32Array(C), isPot: !0 });
            C = null;
            return {
              Ca: !0,
              cb: function () {
      ...
      Zb = (function () {
        return {
          instance: function (a) {
            function c(v) {
              return Y.instance({ isFloat: v, width: d.D, isPot: !1, isFlipY: !1 });
            }
            ...
            A.Qc([
              ...
              { id: 's51', name: '_', h: a, j: l, i: ['u1', 'u32'], precision: 'lowp' },
              {
                id: 's52',
                name: '_',
      ...
      W = {
        ...
        Ae: function (a) {
          function c(g) {
            return [480, 576, 640, 648, 720, 768, 800, 960, 1080, 1152, 1280, 1366, 1920].sort(
              function (t, x) {
            ...
            if (a.video.width.ideal && a.video.height.ideal) {
              ...
              for (r.na = void 0; l < n.length; r = { na: r.na }, ++l) {
                ...
                for (v.ma = void 0; C < q.length; v = { ma: v.ma }, ++C)
                  if (
                    ((v.ma = q[C]), r.na !== a.video.width.ideal || v.ma !== a.video.height.ideal)
                  ) {
          ...
          navigator.mediaDevices
            ...
            .then(function (c) {
              (c = c.filter(function (d) {
                return (
                  d.kind && -1 !== d.kind.toLowerCase().indexOf('video') && d.label && d.deviceId
                );
              })) &&
              c.length &&
              0 < c.length
      ...
      pa = (function () {
        ...
        var c = { n: 5, kc: 1, Gd: 0, bb: [35, 49], Ya: [2, 200], k: 0.7, Qf: 200, tf: 0.05 },
          d = -1,
          e = null,
          m = -1,
          n = -1,
          ...
          g = {
            ...
            ae: function (t) {
              ...
              t - n > e.Qf &&
                5 < ++q &&
                ((x = e.k),
                (r = r * (1 - x) + (m < e.bb[0] ? l - 1 : m > e.bb[1] ? l + 1 : l) * x),
                Math.abs(r - l) > 1 - e.tf &&
      ...
      Ma = (function () {
        ...
        function q(f) {
          f && !I.Z
            ? ((I.Z = !0), H && pa.Gc(), p.port.postMessage('STOP'), aa.be(!0), c())
            : !f && I.Z && ((I.Z = !1), H && pa.vc(1), aa.be(!1), p.port.postMessage('START'));
        }
        function r(f) {
          f.target.hidden ? M() : J();
        }
          ...
          E()
            .then(function (h) {
              ...
              if (++z.Ed > t.Ea) {
                ...
                for (
                  F = 0;
                  F < z.Ec && !(h > z.$a * (1 - (t.Kc[F] + t.he * (F >= z.Bb ? 1 : -1))));
                  ++F
                )
                  F === z.Ec - 1 && ++F;
                F !== z.Bb &&
            ...
            A: function (f) {
              ...
              if (t.ie) {
                ...
                if (
                  ...
                  var G = l(f, f.VERTEX_SHADER, 'attribute vec4 a0;void main(){gl_Position=a0;}'),
                    L = l(
                      f,
                      f.FRAGMENT_SHADER,
                  ...
                  f.bufferData(f.ARRAY_BUFFER, new Float32Array([0.5, 0.5, 0, 1]), f.STATIC_DRAW);
              ...
              if (t.zd) {
                ...
                f &&
                  ('onvisibilitychange' in document
                    ...
                    : (window.addEventListener('blur', M), window.addEventListener('focus', J)),
                  (I.cc = !0));
              }
            ...
            m: function () {
              ...
              I.cc &&
                ('onvisibilitychange' in document
                  ...
                  : (window.removeEventListener('blur', M), window.removeEventListener('focus', J)),
                (I.cc = !1));
      ...
      Eb = {
        ...
        toggle_slow: function (a) {
          Ya() &&
            na === ia.play &&
            (a && !Q.lb
              ? ((Q.Od = Q.fa), (ea.nDetectsPerLoop = 1), this.set_animateDelay(ba.Vf), (Q.lb = !0))
              : !a &&
                Q.lb &&
                ((ea.nDetectsPerLoop = -1), this.set_animateDelay(Q.Od), (Q.lb = !1)));
        },
